...
class GetPlanets(private val planetsRepository: PlanetsRepository) : UseCase<State<PlanetsView>, UseCase.None>() {
    override fun run(params: None?) = planetsRepository.planets()
}
